...
import ru.sbtqa.StubScenario;
import ru.sbtqa.alfatest.cucumber.api.AkitaEnvironment;
import ru.sbtqa.alfatest.cucumber.api.AkitaScenario;
import ru.sbtqa.tests.core.rest.RequestParam;
import ru.sbtqa.tests.core.rest.RequestParamType;
...
import static ru.sbtqa.tests.core.helpers.PropertyLoader.loadValueFromFileOrPropertyOrVariableOrDefault;
import static ru.sbtqa.tests.core.rest.RequestParamType.PARAMETER;
...
public class ApiStepsTest {
    ...
    void getURLwithPathParamsCalculatedSimple() {
        assertThat(resolveVars("sberbank.ru"),
            equalTo("sberbank.ru"));
    }
